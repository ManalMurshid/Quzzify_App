...
//                String userType = (candidateRadio.isChecked()) ? "Candidate" : "Examiner";
//                String batch = (userType.equals("Candidate")) ? batchSpinner.getSelectedItem().toString() : null;
//                String degree = (userType.equals("Candidate")) ? degreeSpinner.getSelectedItem().toString() : null;
//
//                // Add user to the database
//                long result = dbHelper.addUser(username, password, userType, batch, degree);
//
//                if (result != -1) {
...
//                        // Redirect to Examiner HomeActivity
//                         Intent intent = new Intent(LoginActivity.this, HomeActivity.class);
//                         startActivity(intent);
//                    } else {
//                        // Redirect to CandidateActivity
//                         Intent intent = new Intent(LoginActivity.this, CandidateActivity.class);
//                         startActivity(intent);
//                    }
//                } else {
